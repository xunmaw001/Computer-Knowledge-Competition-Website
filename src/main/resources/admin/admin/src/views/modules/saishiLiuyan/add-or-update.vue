    ...
    <div class="addEdit-block">
        <el-form
            ...
            <input id="yonghuId" name="yonghuId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="留言内容" prop="saishiLiuyanText">
                        <el-input type="textarea"  :readonly="ro.saishiLiuyanText" v-model="ruleForm.saishiLiuyanText" placeholder="留言内容"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.saishiLiuyanText" label="留言内容" prop="saishiLiuyanText">
                            <span v-html="ruleForm.saishiLiuyanText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="24">
...
<script>
    ...
    export default {
        ...
        created() {
            ...
            if (this.role != "管理员"){
                this.ro.saishiId = true;//赛事
                this.ro.yonghuId = true;//用户
                this.ro.saishiLiuyanText = true;//留言内容
            }
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`saishiLiuyan/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.saishiLiuyanCrossAddOrUpdateFlag = false;
                                        this.parent.search();
