               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="评委编号" prop="pingweiUuidNumber">
                       <el-input v-model="ruleForm.pingweiUuidNumber"
                                 placeholder="评委编号" clearable  :readonly="ro.pingweiUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="评委姓名" prop="pingweiName">
                       <el-input v-model="ruleForm.pingweiName"
                                 placeholder="评委姓名" clearable  :readonly="ro.pingweiName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="评委手机号" prop="pingweiPhone">
                       <el-input v-model="ruleForm.pingweiPhone"
                                 placeholder="评委手机号" clearable  :readonly="ro.pingweiPhone"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="评委身份证号" prop="pingweiIdNumber">
                       <el-input v-model="ruleForm.pingweiIdNumber"
                                 placeholder="评委身份证号" clearable  :readonly="ro.pingweiIdNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="电子邮箱" prop="pingweiEmail">
                       <el-input v-model="ruleForm.pingweiEmail"
                                 placeholder="电子邮箱" clearable  :readonly="ro.pingweiEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
        ...
        data() {
            return {
                ...
                ro:{
                    username: false,
                    password: false,
                    pingweiUuidNumber: false,
                    pingweiName: false,
                    pingweiPhone: false,
                    pingweiIdNumber: false,
                    pingweiPhoto: false,
                    sexTypes: false,
                    pingweiEmail: false,
                },
                ruleForm: {
                    username: '',
                    password: '',
                    pingweiUuidNumber: new Date().getTime(),
                    pingweiName: '',
                    pingweiPhone: '',
                    pingweiIdNumber: '',
                    pingweiPhoto: '',
                ...
                rules: {
                   ...
                   pingweiUuidNumber: [
                              { required: true, message: '评委编号不能为空', trigger: 'blur' },
                          ],
                   pingweiName: [
                              { required: true, message: '评委姓名不能为空', trigger: 'blur' },
                          ],
                   pingweiPhone: [
                              {  required: true, message: '评委手机号不能为空', trigger: 'blur' },
                   ...
                   pingweiIdNumber: [
                              { required: true, message: '评委身份证号不能为空', trigger: 'blur' },
                   ...
                   pingweiPhoto: [
                              { required: true, message: '评委头像不能为空', trigger: 'blur' },
                          ],
                   sexTypes: [
        ...
        methods: {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.$http({
                            url:`pingwei/${!this.ruleForm.id ? "save" : "update"}`,
                            method: "post",
                            data: this.ruleForm
                        }).then(({ data }) => {
                            if (data && data.code === 0) {
                                this.$message({
                                    ...
                                    onClose: () => {
                                        ...
                                        this.parent.pingweiCrossAddOrUpdateFlag = false;
                                        this.parent.search();
