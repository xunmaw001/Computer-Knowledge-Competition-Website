                ...
                <el-table-column property="caozuo" label="操作">
                    <template slot-scope="scope">
                        <el-button type="info"                          @click="seeForumContent(scope.row.forumContent)">回帖详情</el-button>
                            <el-button v-if="true &&( false|| (sessionTable == 'pingwei' && scope.row.pingweiId ==userId)
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jisuanjizhishijingsaiwangzhan/upload/forumMuBan.xls"
                        >批量导入论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.pingweiId = el.pingweiId;//---
                            forum.pingweiUuidNumber = el.pingweiUuidNumber;
                            forum.pingweiName = el.pingweiName;
                            forum.pingweiPhone = el.pingweiPhone;
                            forum.pingweiIdNumber = el.pingweiIdNumber;
                            forum.pingweiPhoto = el.pingweiPhoto;
                            forum.pingweiEmail = el.pingweiEmail;
                            forum.createTime = el.createTime;
