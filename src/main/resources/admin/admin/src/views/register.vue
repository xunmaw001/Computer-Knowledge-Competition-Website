    ...
    <div>
        <div class="container">
            <div class="login-form">
                <h1 class="h1" style="color:#000;fontSize:28px;">计算机知识竞赛网站注册</h1>
                <el-form class="rgs-form">
                    ...
                    <el-form-item label="重复密码" class="input">
                        ...
                        <el-form-item label="评委姓名" class="input" v-if="tableName=='pingwei'">
                            <el-input v-model="ruleForm.pingweiName" autocomplete="off" placeholder="评委姓名"  />
                        </el-form-item>
                        <el-form-item label="评委手机号" class="input" v-if="tableName=='pingwei'">
                            <el-input v-model="ruleForm.pingweiPhone" autocomplete="off" placeholder="评委手机号"  />
                        </el-form-item>
                        <el-form-item label="评委身份证号" class="input" v-if="tableName=='pingwei'">
                            <el-input v-model="ruleForm.pingweiIdNumber" autocomplete="off" placeholder="评委身份证号"  />
                        </el-form-item>
                        <el-form-item label="电子邮箱" class="input" v-if="tableName=='pingwei'">
                            <el-input v-model="ruleForm.pingweiEmail" autocomplete="off" placeholder="电子邮箱"  />
                        </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            login() {
                            ...
                            if((!this.ruleForm.pingweiName)&& 'pingwei'==this.tableName){
                                this.$message.error('评委姓名不能为空');
                                return
                            }
                             if('pingwei' == this.tableName && this.ruleForm.pingweiPhone&&(!this.$validate.isMobile(this.ruleForm.pingweiPhone))){
                                 this.$message.error('手机应输入手机格式');
                                 return
                             }
                            if((!this.ruleForm.pingweiIdNumber)&& 'pingwei'==this.tableName){
                                this.$message.error('评委身份证号不能为空');
                                return
                            }
                            if('pingwei' == this.tableName && this.ruleForm.pingweiEmail&&(!this.$validate.isEmail(this.ruleForm.pingweiEmail))){
...
.container {
    ...
    background-repeat: no-repeat;
        background-image: url(/jisuanjizhishijingsaiwangzhan/img/back-img-bg.jpg);
