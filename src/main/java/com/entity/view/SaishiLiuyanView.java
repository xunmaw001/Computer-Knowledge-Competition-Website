...
public class SaishiLiuyanView extends SaishiLiuyanEntity implements Serializable {
	...
	public SaishiLiuyanView() {

	}

	public SaishiLiuyanView(SaishiLiuyanEntity saishiLiuyanEntity) {
		try {
			BeanUtils.copyProperties(this, saishiLiuyanEntity);
