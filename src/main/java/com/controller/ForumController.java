...
, "usersId"});//把级联的数据添加到view中,并排除id和创建时间字段,当前表的级联注册表
            ...
            //级联表 评委
            //级联表
            PingweiEntity pingwei = pingweiService.selectById(forum.getPingweiId());
            if(pingwei != null){
    ...
    */
    ...
    public R save(@RequestBody ForumEntity forum, HttpServletRequest request){
        ...
        if(false)
            ...
            forum.setPingweiId(Integer.valueOf(String.valueOf(request.getSession().getAttribute("userId"))));
        ...
        Wrapper<ForumEntity> queryWrapper = new EntityWrapper<ForumEntity>()
            ...
            .eq("pingwei_id", forum.getPingweiId())
...
//                            forumEntity.setPingweiId(Integer.valueOf(data.get(0)));   //评委 要改的
